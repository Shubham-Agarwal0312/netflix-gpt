...
import { addPopupVideoTrailer } from '../utility/store/moviesSlice';

const usePopupMovieTrailer = (movieId) => {
    ...
    const getBackgroundVideo = async () => {
        ...
        dispatch(addPopupVideoTrailer(movieTrailer));
    }
};

export default usePopupMovieTrailer;